...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            super("About Us - WE BELONG TO DIV C(3)");
            ...
            JLabel l7 = new JLabel("HIMANSHU SACHDEV");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("SOHAM SACHDEV");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("JAYESH SACHDEV");
            ...
            JLabel l10 = new JLabel("MPR MINIPROJECT");
